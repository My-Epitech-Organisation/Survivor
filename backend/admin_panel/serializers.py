...
class NewsDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = NewsDetail
        fields = ['id', 'title', 'news_date', 'location', 'category',
                 'startup_id', 'description', 'image_url']
...
class EventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Event
        fields = ['id', 'name', 'dates', 'location', 'description',
                 'event_type', 'target_audience', 'image_url']
...
class StartupDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StartupDetail
        fields = ['id', 'name', 'legal_status', 'address', 'email',
                 'phone', 'created_at', 'description', 'website_url',
                 'social_media_url', 'project_status', 'needs', 'sector',
                 'maturity', 'founders', 'founders_images_urls']
