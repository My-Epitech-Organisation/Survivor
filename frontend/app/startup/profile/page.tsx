            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-app-surface rounded-lg shadow-md p-8">
                        <h3 className="text-2xl font-semibold text-app-text-primary mb-6">Company Information</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                <h4 className="text-lg font-medium text-app-text-primary mb-4">Basic Information</h4>
                                <p className="text-app-text-secondary">Company name, description, industry, etc.</p>
                            </div>

                            <div>
                                <h4 className="text-lg font-medium text-app-text-primary mb-4">Team Management</h4>
                                <p className="text-app-text-secondary">Add and manage team members and roles.</p>
                            </div>
                        </div>
                    </div>
                </div>
