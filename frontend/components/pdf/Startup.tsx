...
export default function StartupPDF({
  projects,
}: {
        ...
        <Page key={project.ProjectId || index} size="A4" style={styles.page}>
          ...
          <View style={styles.highlightBox}>
            <Text style={styles.highlightText}>
              {project.ProjectSector} • {project.ProjectMaturity} •{" "}
              ...
              <View style={styles.section}>
                ...
                <View style={styles.foundersGrid}>
                  {project.ProjectFounders.map((founder, founderIndex) => (
                    <View
                      key={founder.FounderID || founderIndex}
                      style={styles.founderCard}
                    >
                      {founder.FounderPictureURL ? (
                        <Image
                          source={backUrl + founder.FounderPictureURL}
